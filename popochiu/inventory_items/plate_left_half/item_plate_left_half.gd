...
const Data := preload('item_plate_left_half_state.gd')

var state: Data = load('res://popochiu/inventory_items/plate_left_half/item_plate_left_half.tres')
...
func _on_item_used(item: PopochiuInventoryItem) -> void:
	if item == I.PlateRightHalf:
		await I.PlateRightHalf.remove()
