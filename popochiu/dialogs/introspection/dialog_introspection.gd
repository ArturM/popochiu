...
#	await D.say_selected()
	...
	match opt.id:
		"Opt1":
			await C.player.say("I wonder how my life would be next year")
		"Opt2":
			await C.player.say("Is that tree really in this world?")
		"Opt3":
			await C.player.say("What does my happiness depend on?")
			await C.player.say(". . .")
			stop()
